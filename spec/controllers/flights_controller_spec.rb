...
describe FlightsController do
  ...
  def valid_attributes
    {logfile: 'public/uploads/test.igc'}
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved flight as @flight" do
        ...
        post :create, {:flight => {}}, valid_session
        assigns(:flight).should be_a_new(Flight)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested flight" do
        ...
        put :update, {:id => flight.to_param, :flight => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the flight as @flight" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Flight.any_instance.stub(:save).and_return(false)
        put :update, {:id => flight.to_param, :flight => {}}, valid_session
        assigns(:flight).should eq(flight)
      end
